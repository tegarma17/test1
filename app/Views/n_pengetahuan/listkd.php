...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= base_url('n_pengetahuan') ?>" class="btn"><i class="fas fa-arrow-left"></i></a>
        </div>
                    ...
                    <tbody>
                        ...
                        <?php foreach ($kd as $key => $value) : ?>
                            <tr>
                                ...
                                <td><?= $value['nama_kd'] ?></td>
                                <td>
                                    <a href="<?= base_url('n_pengetahuan/nilaitugas/' . $kd[$index]['id']) ?>" class="btn btn-primary btn-sm"></i>TUGAS</a>
                                    <a href="<?= base_url('n_pengetahuan/nilaiUH/' . $kd[$index]['id']) ?>" class="btn btn-primary btn-sm"></i>ULANGAN HARIAN</a>
                                    <a href="<?= base_url('n_pengetahuan/nilaiUTS/' . $kd[$index]['id']) ?>" class="btn btn-primary btn-sm"></i>UTS</a>
                                    <a href="<?= base_url('n_pengetahuan/nilaiUAS/' . $kd[$index]['id']) ?>" class="btn btn-primary btn-sm"></i>UAS</a>
                                </td>
                                <?php $index++; ?>
                            <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('n_pengetahuan/tambahkd/' . $id_mapel); ?>" autocomplete="off">
