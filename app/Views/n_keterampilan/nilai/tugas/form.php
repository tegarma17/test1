...
<section class="section">
    <div class="section-header">
        <div class="section-header-back">
            <a href="<?= base_url('n_keterampilan/kd/' . $id_mapel) ?>" class="btn"><i class="fas fa-arrow-left"></i></a>
        </div>
        <h1>Data Nilai</h1>
    ...
    <div class="section-body">
        <div class="card">
            <div class="card-header">
                <h4>Data Nilai / Nilai Pengetahuan / Nilai Tugas</h4>
            </div>
                ...
                <table class="table table-striped table-md">
                    <tbody>
                        ...
                        <?php foreach ($data_siswa as $key => $value) : ?>
                            <form method="POST" action="<?= base_url('n_keterampilan/simpanTugas'); ?>" autocomplete="off" multiple>
                                <tr>
